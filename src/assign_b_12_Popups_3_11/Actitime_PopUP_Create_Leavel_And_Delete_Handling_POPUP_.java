...
public class Actitime_PopUP_Create_Leavel_And_Delete_Handling_POPUP_ {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("(//span[.='Create Leave Type'])[1]")).clear();
		driver.findElement(By.xpath("//td[@class='leaveTypeDeleteCell last active']")).click();//Delete Static and Dynamic
