...
public class FB_Enter_M_NO_PWD {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//input[@name='reg_email__']")).sendKeys("887766554443");
		driver.findElement(By.xpath("//input[@name='reg_passwd__']")).sendKeys("rccsfffayff");
		driver.close();
