package assign_a_5_Xpath_By_Contains;
...
public class Create_Page_Print_WebElement {
	...
	public static void main(String[] args) {
		...
		WebElement link=driver.findElement(By.xpath("//a[contains(text(),'Create Page')]"));
		System.out.println(link.getText());
		link.click();
		//System.out.println(link.getText());//if we sopln put hare then exception ?
