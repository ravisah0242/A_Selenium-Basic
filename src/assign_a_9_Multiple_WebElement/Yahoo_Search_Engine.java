...
public class Yahoo_Search_Engine {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("(//input[@type='text'])[1]")).sendKeys("cricket");
		Thread.sleep(5000);
		List<WebElement> suggestions=driver.findElements(By.xpath("//b[contains(text(),'cricket')]"));
		System.out.println(suggestions.size());
		for(int i=0;i<suggestions.size();i++)   
		{
			if(suggestions.get(i).getText().equalsIgnoreCase("cricket"))
			{
